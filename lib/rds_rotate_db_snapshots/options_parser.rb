  ...
  class OptionsParser
    ...
    def init_cli_parser
      @parser ||= OptionParser.new do |o|
        ...
        o.on("--keep-last", "Keep the most recent snapshot, regardless of time-based policy") do |_v|
          @options[:keep_last] = true
        end

        o.on("--dry-run", "Shows what would happen without doing anything") do |_v|
